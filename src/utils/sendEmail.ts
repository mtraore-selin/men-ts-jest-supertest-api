...
let htmlContent = ` <div style="max-width: 700px; margin:auto; border: 10px solid #ddd; padding: 50px 20px; font-size: 110%;">
        <h2
          style="text-align: center; text-transform: uppercase;color: teal;
            "
        >
          Welcome to Codding With Mohamed.
        </h2>
        <div style=" font-size: 1.3rem ">
          <p>Congratulations! You successfully signed up to Mohamed App!</p>
          <p> click the button below to flow Mohamed on Gitub </p>
          <a
            ...
            <tr>
              <td style="text-align:center;">
                <p style="font-size:14px; color:rgba(69, 80, 86, 0.7411764705882353); line-height:18px; margin:0 0 0;">
                  &copy; <strong>www.mohamed.com</strong>
                </p>
              </td>
            </tr>
            <tr>
